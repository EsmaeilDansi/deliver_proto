...
export class QueryServiceClient {
    constructor(settings, clientFactory, handler) {
        ...
        this.$raw = {
            ...
            /**
             * Unary call: /proto.pub.v1.query.QueryService/GetAnnouncement
             *
             * @param requestMessage Request message
             * @param requestMetadata Request metadata
             * @returns Observable<GrpcEvent<thisProto.GetAnnouncementRes>>
             */
            getAnnouncement: (requestData, requestMetadata = new GrpcMetadata()) => {
                return this.handler.handle({
                    type: GrpcCallType.unary,
                    client: this.client,
                    path: '/proto.pub.v1.query.QueryService/GetAnnouncement',
                    requestData,
                    requestMetadata,
                    requestClass: thisProto.GetAnnouncementReq,
                    responseClass: thisProto.GetAnnouncementRes
                });
            }
        };
     ...
     * @param requestMessage Request message
     * @param requestMetadata Request metadata
     * @returns Observable<thisProto.GetAnnouncementRes>
     */
    getAnnouncement(requestData, requestMetadata = new GrpcMetadata()) {
        return this.$raw
            .getAnnouncement(requestData, requestMetadata)
            .pipe(throwStatusErrors(), takeMessages());
    }
}
