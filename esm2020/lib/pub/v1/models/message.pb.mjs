...
export class Message {
    ...
    constructor(_value) {
        ...
        this.paymentInformation = _value.paymentInformation
            ? new protoPubV1Models006.PaymentInformation(_value.paymentInformation)
            : undefined;
        ...
        while (_reader.nextField()) {
            ...
            switch (_reader.getFieldNumber()) {
                ...
                case 32:
                    ...
                    break;
                case 35:
                    _instance.paymentInformation = new protoPubV1Models006.PaymentInformation();
                    _reader.readMessage(_instance.paymentInformation, protoPubV1Models006.PaymentInformation.deserializeBinaryFromReader);
                    break;
                default:
                    _reader.skipField();
            }
    ...
    static serializeBinaryToWriter(_instance, _writer) {
        ...
        if (_instance.paymentInformation) {
            _writer.writeMessage(35, _instance.paymentInformation, protoPubV1Models006.PaymentInformation.serializeBinaryToWriter);
        }
    }
    get packetId() {
        return this._packetId;
