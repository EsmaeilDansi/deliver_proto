...
export class ChannelAdmin {
    ...
    static serializeBinaryToWriter(_instance, _writer) {
        ...
        if (_instance.channel) {
            _writer.writeMessage(2, _instance.channel, protoPubV1Models001.Uid.serializeBinaryToWriter);
        }
    }
    get admin() {
        return this._admin;
