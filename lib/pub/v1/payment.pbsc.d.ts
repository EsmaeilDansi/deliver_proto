...
export declare class PaymentServiceClient {
    ...
    $raw: {
         ...
         * @returns Observable<GrpcEvent<thisProto.PayRes>>
         */
        payConfirm: (requestData: thisProto.PayConfirmReq, requestMetadata?: GrpcMetadata) => Observable<GrpcEvent<thisProto.PayRes>>;
        /**
     ...
     * @returns Observable<thisProto.PayRes>
     */
    payConfirm(requestData: thisProto.PayConfirmReq, requestMetadata?: GrpcMetadata): Observable<thisProto.PayRes>;
    /**
     * Unary call @/proto.pub.v1.payment.PaymentService/Transfer
     *
     * @param requestMessage Request message
