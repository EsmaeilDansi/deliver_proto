...
import * as protoPubV1Models013 from '../../pub/v1/models/settings.pb';
...
import * as protoPubV1Models021 from '../../pub/v1/models/last-seen.pb';
...
/**
 * Message implementation for proto.pub.v1.query.GetIsVerifiedReq
 */
export declare class GetIsVerifiedReq implements GrpcMessage {
    static id: string;
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
    static deserializeBinary(bytes: ByteSource): GetIsVerifiedReq;
    /**
     * Check all the properties and set default protobuf values if necessary
     * @param _instance message instance
     */
    static refineValues(_instance: GetIsVerifiedReq): void;
    /**
     * Deserializes / reads binary message into message instance using provided binary reader
     * @param _instance message instance
     * @param _reader binary reader instance
     */
    static deserializeBinaryFromReader(_instance: GetIsVerifiedReq, _reader: BinaryReader): void;
    /**
     * Serializes a message to binary format using provided binary reader
     * @param _instance message instance
     * @param _writer binary writer instance
     */
    static serializeBinaryToWriter(_instance: GetIsVerifiedReq, _writer: BinaryWriter): void;
    private _uid?;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
     * @param _value initial values object or instance of GetIsVerifiedReq to deeply clone from
     */
    constructor(_value?: RecursivePartial<GetIsVerifiedReq.AsObject>);
    get uid(): protoPubV1Models000.Uid | undefined;
    set uid(value: protoPubV1Models000.Uid | undefined);
    /**
     * Serialize message to binary data
     ...
     * Cast message to standard JavaScript object (all non-primitive values are deeply cloned)
     */
    toObject(): GetIsVerifiedReq.AsObject;
    /**
     * Convenience method to support JSON.stringify(message), replicates the structure of toObject()
     */
    toJSON(): GetIsVerifiedReq.AsObject;
    /**
     * Cast message to JSON using protobuf JSON notation: https://developers.google.com/protocol-buffers/docs/proto3#json
     * Attention: output differs from toObject() e.g. enums are represented as names and not as numbers, Timestamp is an ISO Date string format etc.
     * If the message itself or some of descendant messages is google.protobuf.Any, you MUST provide a message pool as options. If not, the messagePool is not required
     */
    toProtobufJSON(options?: ToProtobufJSONOptions): GetIsVerifiedReq.AsProtobufJSON;
}
export declare module GetIsVerifiedReq {
    /**
     * Standard JavaScript object representation for GetIsVerifiedReq
     */
    interface AsObject {
        uid?: protoPubV1Models000.Uid.AsObject;
    }
    /**
     * Protobuf JSON representation for GetIsVerifiedReq
     */
    interface AsProtobufJSON {
        uid?: protoPubV1Models000.Uid.AsProtobufJSON | null;
    }
...
/**
 * Message implementation for proto.pub.v1.query.GetIsVerifiedRes
 */
export declare class GetIsVerifiedRes implements GrpcMessage {
    static id: string;
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
    static deserializeBinary(bytes: ByteSource): GetIsVerifiedRes;
    /**
     * Check all the properties and set default protobuf values if necessary
     * @param _instance message instance
     */
    static refineValues(_instance: GetIsVerifiedRes): void;
    /**
     * Deserializes / reads binary message into message instance using provided binary reader
     * @param _instance message instance
     * @param _reader binary reader instance
     */
    static deserializeBinaryFromReader(_instance: GetIsVerifiedRes, _reader: BinaryReader): void;
    /**
     * Serializes a message to binary format using provided binary reader
     * @param _instance message instance
     * @param _writer binary writer instance
     */
    static serializeBinaryToWriter(_instance: GetIsVerifiedRes, _writer: BinaryWriter): void;
    private _expireTime?;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
     * @param _value initial values object or instance of GetIsVerifiedRes to deeply clone from
     */
    constructor(_value?: RecursivePartial<GetIsVerifiedRes.AsObject>);
     ...
     * Cast message to standard JavaScript object (all non-primitive values are deeply cloned)
     */
    toObject(): GetIsVerifiedRes.AsObject;
    /**
     * Convenience method to support JSON.stringify(message), replicates the structure of toObject()
     */
    toJSON(): GetIsVerifiedRes.AsObject;
    /**
     * Cast message to JSON using protobuf JSON notation: https://developers.google.com/protocol-buffers/docs/proto3#json
     * Attention: output differs from toObject() e.g. enums are represented as names and not as numbers, Timestamp is an ISO Date string format etc.
     * If the message itself or some of descendant messages is google.protobuf.Any, you MUST provide a message pool as options. If not, the messagePool is not required
     */
    toProtobufJSON(options?: ToProtobufJSONOptions): GetIsVerifiedRes.AsProtobufJSON;
}
export declare module GetIsVerifiedRes {
    /**
     * Standard JavaScript object representation for GetIsVerifiedRes
     */
    interface AsObject {
        expireTime?: string;
    }
    /**
     * Protobuf JSON representation for GetIsVerifiedRes
     */
    interface AsProtobufJSON {
        expireTime?: string;
    }
...
export declare class GetLastActivityRes implements GrpcMessage {
    ...
    get lastSeenStatus(): protoPubV1Models021.LastSeenStatus | undefined;
    set lastSeenStatus(value: protoPubV1Models021.LastSeenStatus | undefined);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
...
export declare module GetLastActivityRes {
    ...
    interface AsObject {
        ...
        lastSeenStatus?: protoPubV1Models021.LastSeenStatus;
    }
    /**
...
/**
 * Message implementation for proto.pub.v1.query.CheckCallAvailabilityStatusReq
 */
export declare class CheckCallAvailabilityStatusReq implements GrpcMessage {
    static id: string;
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
    static deserializeBinary(bytes: ByteSource): CheckCallAvailabilityStatusReq;
    /**
     * Check all the properties and set default protobuf values if necessary
     * @param _instance message instance
     */
    static refineValues(_instance: CheckCallAvailabilityStatusReq): void;
    /**
     * Deserializes / reads binary message into message instance using provided binary reader
     * @param _instance message instance
     * @param _reader binary reader instance
     */
    static deserializeBinaryFromReader(_instance: CheckCallAvailabilityStatusReq, _reader: BinaryReader): void;
    /**
     * Serializes a message to binary format using provided binary reader
     * @param _instance message instance
     * @param _writer binary writer instance
     */
    static serializeBinaryToWriter(_instance: CheckCallAvailabilityStatusReq, _writer: BinaryWriter): void;
    private _uid?;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
     * @param _value initial values object or instance of CheckCallAvailabilityStatusReq to deeply clone from
     */
    constructor(_value?: RecursivePartial<CheckCallAvailabilityStatusReq.AsObject>);
    get uid(): protoPubV1Models000.Uid | undefined;
    set uid(value: protoPubV1Models000.Uid | undefined);
    /**
     * Serialize message to binary data
     ...
     * Cast message to standard JavaScript object (all non-primitive values are deeply cloned)
     */
    toObject(): CheckCallAvailabilityStatusReq.AsObject;
    /**
     * Convenience method to support JSON.stringify(message), replicates the structure of toObject()
     */
    toJSON(): CheckCallAvailabilityStatusReq.AsObject;
    /**
     * Cast message to JSON using protobuf JSON notation: https://developers.google.com/protocol-buffers/docs/proto3#json
     * Attention: output differs from toObject() e.g. enums are represented as names and not as numbers, Timestamp is an ISO Date string format etc.
     * If the message itself or some of descendant messages is google.protobuf.Any, you MUST provide a message pool as options. If not, the messagePool is not required
     */
    toProtobufJSON(options?: ToProtobufJSONOptions): CheckCallAvailabilityStatusReq.AsProtobufJSON;
}
export declare module CheckCallAvailabilityStatusReq {
    /**
     * Standard JavaScript object representation for CheckCallAvailabilityStatusReq
     */
    interface AsObject {
        uid?: protoPubV1Models000.Uid.AsObject;
    }
    /**
     * Protobuf JSON representation for CheckCallAvailabilityStatusReq
     */
    interface AsProtobufJSON {
        uid?: protoPubV1Models000.Uid.AsProtobufJSON | null;
    }
...
/**
 * Message implementation for proto.pub.v1.query.CheckCallAvailabilityStatusRes
 */
export declare class CheckCallAvailabilityStatusRes implements GrpcMessage {
    static id: string;
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
    static deserializeBinary(bytes: ByteSource): CheckCallAvailabilityStatusRes;
    /**
     * Check all the properties and set default protobuf values if necessary
     * @param _instance message instance
     */
    static refineValues(_instance: CheckCallAvailabilityStatusRes): void;
    /**
     * Deserializes / reads binary message into message instance using provided binary reader
     * @param _instance message instance
     * @param _reader binary reader instance
     */
    static deserializeBinaryFromReader(_instance: CheckCallAvailabilityStatusRes, _reader: BinaryReader): void;
    /**
     * Serializes a message to binary format using provided binary reader
     * @param _instance message instance
     * @param _writer binary writer instance
     */
    static serializeBinaryToWriter(_instance: CheckCallAvailabilityStatusRes, _writer: BinaryWriter): void;
    private _isAllowed?;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
     * @param _value initial values object or instance of CheckCallAvailabilityStatusRes to deeply clone from
     */
    constructor(_value?: RecursivePartial<CheckCallAvailabilityStatusRes.AsObject>);
    get isAllowed(): boolean | undefined;
    set isAllowed(value: boolean | undefined);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
     ...
     * Cast message to standard JavaScript object (all non-primitive values are deeply cloned)
     */
    toObject(): CheckCallAvailabilityStatusRes.AsObject;
    /**
     * Convenience method to support JSON.stringify(message), replicates the structure of toObject()
     */
    toJSON(): CheckCallAvailabilityStatusRes.AsObject;
    /**
     * Cast message to JSON using protobuf JSON notation: https://developers.google.com/protocol-buffers/docs/proto3#json
     * Attention: output differs from toObject() e.g. enums are represented as names and not as numbers, Timestamp is an ISO Date string format etc.
     * If the message itself or some of descendant messages is google.protobuf.Any, you MUST provide a message pool as options. If not, the messagePool is not required
     */
    toProtobufJSON(options?: ToProtobufJSONOptions): CheckCallAvailabilityStatusRes.AsProtobufJSON;
}
export declare module CheckCallAvailabilityStatusRes {
    /**
     * Standard JavaScript object representation for CheckCallAvailabilityStatusRes
     */
    interface AsObject {
        isAllowed?: boolean;
    }
    /**
     * Protobuf JSON representation for CheckCallAvailabilityStatusRes
     */
    interface AsProtobufJSON {
        isAllowed?: boolean;
    }
...
/**
 * Message implementation for proto.pub.v1.query.SaveLocalMessageReq
 */
export declare class SaveLocalMessageReq implements GrpcMessage {
    static id: string;
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
    static deserializeBinary(bytes: ByteSource): SaveLocalMessageReq;
    /**
     * Check all the properties and set default protobuf values if necessary
     * @param _instance message instance
     */
    static refineValues(_instance: SaveLocalMessageReq): void;
    /**
     * Deserializes / reads binary message into message instance using provided binary reader
     * @param _instance message instance
     * @param _reader binary reader instance
     */
    static deserializeBinaryFromReader(_instance: SaveLocalMessageReq, _reader: BinaryReader): void;
    /**
     * Serializes a message to binary format using provided binary reader
     * @param _instance message instance
     * @param _writer binary writer instance
     */
    static serializeBinaryToWriter(_instance: SaveLocalMessageReq, _writer: BinaryWriter): void;
    private _localChatId?;
    private _messages?;
    private _roomUid?;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
     * @param _value initial values object or instance of SaveLocalMessageReq to deeply clone from
     */
    constructor(_value?: RecursivePartial<SaveLocalMessageReq.AsObject>);
    get localChatId(): string | undefined;
    set localChatId(value: string | undefined);
    get messages(): protoPubV1Models014.LocalChatMessage[] | undefined;
    set messages(value: protoPubV1Models014.LocalChatMessage[] | undefined);
     ...
     * Cast message to standard JavaScript object (all non-primitive values are deeply cloned)
     */
    toObject(): SaveLocalMessageReq.AsObject;
    /**
     * Convenience method to support JSON.stringify(message), replicates the structure of toObject()
     */
    toJSON(): SaveLocalMessageReq.AsObject;
    /**
     * Cast message to JSON using protobuf JSON notation: https://developers.google.com/protocol-buffers/docs/proto3#json
     * Attention: output differs from toObject() e.g. enums are represented as names and not as numbers, Timestamp is an ISO Date string format etc.
     * If the message itself or some of descendant messages is google.protobuf.Any, you MUST provide a message pool as options. If not, the messagePool is not required
     */
    toProtobufJSON(options?: ToProtobufJSONOptions): SaveLocalMessageReq.AsProtobufJSON;
}
export declare module SaveLocalMessageReq {
    /**
     * Standard JavaScript object representation for SaveLocalMessageReq
     */
    interface AsObject {
        localChatId?: string;
        messages?: protoPubV1Models014.LocalChatMessage.AsObject[];
        roomUid?: protoPubV1Models000.Uid.AsObject;
    }
    /**
     * Protobuf JSON representation for SaveLocalMessageReq
     */
    interface AsProtobufJSON {
        localChatId?: string;
        messages?: protoPubV1Models014.LocalChatMessage.AsProtobufJSON[] | null;
        roomUid?: protoPubV1Models000.Uid.AsProtobufJSON | null;
    }
}
/**
 * Message implementation for proto.pub.v1.query.SaveLocalMessageRes
 */
export declare class SaveLocalMessageRes implements GrpcMessage {
    static id: string;
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
    static deserializeBinary(bytes: ByteSource): SaveLocalMessageRes;
    /**
     * Check all the properties and set default protobuf values if necessary
     * @param _instance message instance
     */
    static refineValues(_instance: SaveLocalMessageRes): void;
    /**
     * Deserializes / reads binary message into message instance using provided binary reader
     * @param _instance message instance
     * @param _reader binary reader instance
     */
    static deserializeBinaryFromReader(_instance: SaveLocalMessageRes, _reader: BinaryReader): void;
    /**
     * Serializes a message to binary format using provided binary reader
     * @param _instance message instance
     * @param _writer binary writer instance
     */
    static serializeBinaryToWriter(_instance: SaveLocalMessageRes, _writer: BinaryWriter): void;
    private _lastMessageId?;
    private _lastLocalChatId?;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
     * @param _value initial values object or instance of SaveLocalMessageRes to deeply clone from
     */
    constructor(_value?: RecursivePartial<SaveLocalMessageRes.AsObject>);
    get lastMessageId(): string | undefined;
    set lastMessageId(value: string | undefined);
    get lastLocalChatId(): string | undefined;
    set lastLocalChatId(value: string | undefined);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
     ...
     * Cast message to standard JavaScript object (all non-primitive values are deeply cloned)
     */
    toObject(): SaveLocalMessageRes.AsObject;
    /**
     * Convenience method to support JSON.stringify(message), replicates the structure of toObject()
     */
    toJSON(): SaveLocalMessageRes.AsObject;
    /**
     * Cast message to JSON using protobuf JSON notation: https://developers.google.com/protocol-buffers/docs/proto3#json
     * Attention: output differs from toObject() e.g. enums are represented as names and not as numbers, Timestamp is an ISO Date string format etc.
     * If the message itself or some of descendant messages is google.protobuf.Any, you MUST provide a message pool as options. If not, the messagePool is not required
     */
    toProtobufJSON(options?: ToProtobufJSONOptions): SaveLocalMessageRes.AsProtobufJSON;
}
export declare module SaveLocalMessageRes {
    /**
     * Standard JavaScript object representation for SaveLocalMessageRes
     */
    interface AsObject {
        lastMessageId?: string;
        lastLocalChatId?: string;
    }
    /**
     * Protobuf JSON representation for SaveLocalMessageRes
     */
    interface AsProtobufJSON {
        lastMessageId?: string;
        lastLocalChatId?: string;
...
export declare class FetchMessagesRes implements GrpcMessage {
    ...
    get messages(): protoPubV1Models014.Message[] | undefined;
    set messages(value: protoPubV1Models014.Message[] | undefined);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
...
export declare module FetchMessagesRes {
     ...
     */
    interface AsObject {
        messages?: protoPubV1Models014.Message.AsObject[];
    }
    /**
     * Protobuf JSON representation for FetchMessagesRes
     */
    interface AsProtobufJSON {
        messages?: protoPubV1Models014.Message.AsProtobufJSON[] | null;
    }
}
/**
...
export declare class GetAllUserRoomMetaRes implements GrpcMessage {
    ...
    get roomsMeta(): protoPubV1Models018.RoomMetadata[] | undefined;
    set roomsMeta(value: protoPubV1Models018.RoomMetadata[] | undefined);
...
export declare module GetAllUserRoomMetaRes {
     ...
     */
    interface AsObject {
        roomsMeta?: protoPubV1Models018.RoomMetadata.AsObject[];
        finished?: boolean;
    }
    /**
     ...
     */
    interface AsProtobufJSON {
        roomsMeta?: protoPubV1Models018.RoomMetadata.AsProtobufJSON[] | null;
        finished?: boolean;
    }
}
/**
...
export declare class GetUserRoomMetaRes implements GrpcMessage {
    ...
    get roomMeta(): protoPubV1Models018.RoomMetadata | undefined;
    set roomMeta(value: protoPubV1Models018.RoomMetadata | undefined);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
...
export declare module GetUserRoomMetaRes {
     ...
     */
    interface AsObject {
        roomMeta?: protoPubV1Models018.RoomMetadata.AsObject;
    }
    /**
     * Protobuf JSON representation for GetUserRoomMetaRes
     */
    interface AsProtobufJSON {
        roomMeta?: protoPubV1Models018.RoomMetadata.AsProtobufJSON | null;
    }
}
/**
...
export declare class GetUserLastDeliveryAckRes implements GrpcMessage {
    ...
    get lastMessageDeliveryAck(): protoPubV1Models014.MessageDeliveryAck | undefined;
    set lastMessageDeliveryAck(value: protoPubV1Models014.MessageDeliveryAck | undefined);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
...
export declare module GetUserLastDeliveryAckRes {
     ...
     */
    interface AsObject {
        lastMessageDeliveryAck?: protoPubV1Models014.MessageDeliveryAck.AsObject;
    }
    /**
     * Protobuf JSON representation for GetUserLastDeliveryAckRes
     */
    interface AsProtobufJSON {
        lastMessageDeliveryAck?: protoPubV1Models014.MessageDeliveryAck.AsProtobufJSON | null;
    }
}
/**
...
export declare class FetchMediasRes implements GrpcMessage {
    ...
    get medias(): protoPubV1Models015.Media[] | undefined;
    set medias(value: protoPubV1Models015.Media[] | undefined);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
...
export declare module FetchMediasRes {
     ...
     */
    interface AsObject {
        medias?: protoPubV1Models015.Media.AsObject[];
    }
    /**
     * Protobuf JSON representation for FetchMediasRes
     */
    interface AsProtobufJSON {
        medias?: protoPubV1Models015.Media.AsProtobufJSON[] | null;
    }
}
/**
...
export declare class FetchMetaListReq implements GrpcMessage {
    ...
    get pointer(): string | undefined;
    set pointer(value: string | undefined);
    get group(): protoPubV1Models016.MetaGroup | undefined;
    set group(value: protoPubV1Models016.MetaGroup | undefined);
...
export declare module FetchMetaListReq {
    ...
    interface AsObject {
        roomUid?: protoPubV1Models000.Uid.AsObject;
        pointer?: string;
        group?: protoPubV1Models016.MetaGroup;
...
export declare class FetchMetaListRes implements GrpcMessage {
    ...
    get metaList(): protoPubV1Models016.Meta[] | undefined;
    set metaList(value: protoPubV1Models016.Meta[] | undefined);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
...
export declare module FetchMetaListRes {
     ...
     */
    interface AsObject {
        metaList?: protoPubV1Models016.Meta.AsObject[];
    }
    /**
     * Protobuf JSON representation for FetchMetaListRes
     */
    interface AsProtobufJSON {
        metaList?: protoPubV1Models016.Meta.AsProtobufJSON[] | null;
    }
}
/**
...
export declare class FetchCurrentUserSeenDataRes implements GrpcMessage {
    ...
    get seen(): protoPubV1Models017.Seen | undefined;
    set seen(value: protoPubV1Models017.Seen | undefined);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
...
export declare module FetchCurrentUserSeenDataRes {
     ...
     */
    interface AsObject {
        seen?: protoPubV1Models017.Seen.AsObject;
    }
    /**
     * Protobuf JSON representation for FetchCurrentUserSeenDataRes
     */
    interface AsProtobufJSON {
        seen?: protoPubV1Models017.Seen.AsProtobufJSON | null;
    }
}
/**
...
export declare class UpdateMessageReq implements GrpcMessage {
    ...
    get messageId(): string | undefined;
    set messageId(value: string | undefined);
    get message(): protoPubV1Models014.MessageByClient | undefined;
    set message(value: protoPubV1Models014.MessageByClient | undefined);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
...
export declare module UpdateMessageReq {
    ...
    interface AsObject {
        messageId?: string;
        message?: protoPubV1Models014.MessageByClient.AsObject;
    }
    /**
    ...
    interface AsProtobufJSON {
        messageId?: string;
        message?: protoPubV1Models014.MessageByClient.AsProtobufJSON | null;
    }
}
/**
...
export declare class AddAvatarReq implements GrpcMessage {
    ...
    get avatar(): protoPubV1Models019.Avatar | undefined;
    set avatar(value: protoPubV1Models019.Avatar | undefined);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
...
export declare module AddAvatarReq {
     ...
     */
    interface AsObject {
        avatar?: protoPubV1Models019.Avatar.AsObject;
    }
    /**
     * Protobuf JSON representation for AddAvatarReq
     */
    interface AsProtobufJSON {
        avatar?: protoPubV1Models019.Avatar.AsProtobufJSON | null;
    }
}
/**
...
/**
 * Message implementation for proto.pub.v1.query.SetMuteSettingsOfRoomReq
 */
export declare class SetMuteSettingsOfRoomReq implements GrpcMessage {
    static id: string;
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
    static deserializeBinary(bytes: ByteSource): SetMuteSettingsOfRoomReq;
    /**
     * Check all the properties and set default protobuf values if necessary
     * @param _instance message instance
     */
    static refineValues(_instance: SetMuteSettingsOfRoomReq): void;
    /**
     * Deserializes / reads binary message into message instance using provided binary reader
     * @param _instance message instance
     * @param _reader binary reader instance
     */
    static deserializeBinaryFromReader(_instance: SetMuteSettingsOfRoomReq, _reader: BinaryReader): void;
    /**
     * Serializes a message to binary format using provided binary reader
     * @param _instance message instance
     * @param _writer binary writer instance
     */
    static serializeBinaryToWriter(_instance: SetMuteSettingsOfRoomReq, _writer: BinaryWriter): void;
    private _room?;
    private _settings?;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
     * @param _value initial values object or instance of SetMuteSettingsOfRoomReq to deeply clone from
     */
    constructor(_value?: RecursivePartial<SetMuteSettingsOfRoomReq.AsObject>);
    get room(): protoPubV1Models000.Uid | undefined;
    set room(value: protoPubV1Models000.Uid | undefined);
    get settings(): protoPubV1Models013.MuteSettings | undefined;
    set settings(value: protoPubV1Models013.MuteSettings | undefined);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
     ...
     * Cast message to standard JavaScript object (all non-primitive values are deeply cloned)
     */
    toObject(): SetMuteSettingsOfRoomReq.AsObject;
    /**
     * Convenience method to support JSON.stringify(message), replicates the structure of toObject()
     */
    toJSON(): SetMuteSettingsOfRoomReq.AsObject;
    /**
     * Cast message to JSON using protobuf JSON notation: https://developers.google.com/protocol-buffers/docs/proto3#json
     * Attention: output differs from toObject() e.g. enums are represented as names and not as numbers, Timestamp is an ISO Date string format etc.
     * If the message itself or some of descendant messages is google.protobuf.Any, you MUST provide a message pool as options. If not, the messagePool is not required
     */
    toProtobufJSON(options?: ToProtobufJSONOptions): SetMuteSettingsOfRoomReq.AsProtobufJSON;
}
export declare module SetMuteSettingsOfRoomReq {
    /**
     * Standard JavaScript object representation for SetMuteSettingsOfRoomReq
     */
    interface AsObject {
        room?: protoPubV1Models000.Uid.AsObject;
        settings?: protoPubV1Models013.MuteSettings.AsObject;
    }
    /**
     * Protobuf JSON representation for SetMuteSettingsOfRoomReq
     */
    interface AsProtobufJSON {
        room?: protoPubV1Models000.Uid.AsProtobufJSON | null;
        settings?: protoPubV1Models013.MuteSettings.AsProtobufJSON | null;
    }
}
/**
 * Message implementation for proto.pub.v1.query.SetMuteSettingsOfRoomRes
 */
export declare class SetMuteSettingsOfRoomRes implements GrpcMessage {
    static id: string;
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
    static deserializeBinary(bytes: ByteSource): SetMuteSettingsOfRoomRes;
    /**
     * Check all the properties and set default protobuf values if necessary
     * @param _instance message instance
     */
    static refineValues(_instance: SetMuteSettingsOfRoomRes): void;
    /**
     * Deserializes / reads binary message into message instance using provided binary reader
     * @param _instance message instance
     * @param _reader binary reader instance
     */
    static deserializeBinaryFromReader(_instance: SetMuteSettingsOfRoomRes, _reader: BinaryReader): void;
    /**
     * Serializes a message to binary format using provided binary reader
     * @param _instance message instance
     * @param _writer binary writer instance
     */
    static serializeBinaryToWriter(_instance: SetMuteSettingsOfRoomRes, _writer: BinaryWriter): void;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
     * @param _value initial values object or instance of SetMuteSettingsOfRoomRes to deeply clone from
     */
    constructor(_value?: RecursivePartial<SetMuteSettingsOfRoomRes.AsObject>);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
     ...
     * Cast message to standard JavaScript object (all non-primitive values are deeply cloned)
     */
    toObject(): SetMuteSettingsOfRoomRes.AsObject;
    /**
     * Convenience method to support JSON.stringify(message), replicates the structure of toObject()
     */
    toJSON(): SetMuteSettingsOfRoomRes.AsObject;
    /**
     * Cast message to JSON using protobuf JSON notation: https://developers.google.com/protocol-buffers/docs/proto3#json
     * Attention: output differs from toObject() e.g. enums are represented as names and not as numbers, Timestamp is an ISO Date string format etc.
     * If the message itself or some of descendant messages is google.protobuf.Any, you MUST provide a message pool as options. If not, the messagePool is not required
     */
    toProtobufJSON(options?: ToProtobufJSONOptions): SetMuteSettingsOfRoomRes.AsProtobufJSON;
}
export declare module SetMuteSettingsOfRoomRes {
    /**
     * Standard JavaScript object representation for SetMuteSettingsOfRoomRes
     */
    interface AsObject {
    }
    /**
     * Protobuf JSON representation for SetMuteSettingsOfRoomRes
     */
    interface AsProtobufJSON {
    }
}
/**
 * Message implementation for proto.pub.v1.query.UpdateSettingsReq
 */
export declare class UpdateSettingsReq implements GrpcMessage {
    static id: string;
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
    static deserializeBinary(bytes: ByteSource): UpdateSettingsReq;
    /**
     * Check all the properties and set default protobuf values if necessary
     * @param _instance message instance
     */
    static refineValues(_instance: UpdateSettingsReq): void;
    /**
     * Deserializes / reads binary message into message instance using provided binary reader
     * @param _instance message instance
     * @param _reader binary reader instance
     */
    static deserializeBinaryFromReader(_instance: UpdateSettingsReq, _reader: BinaryReader): void;
    /**
     * Serializes a message to binary format using provided binary reader
     * @param _instance message instance
     * @param _writer binary writer instance
     */
    static serializeBinaryToWriter(_instance: UpdateSettingsReq, _writer: BinaryWriter): void;
    private _settings?;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
     * @param _value initial values object or instance of UpdateSettingsReq to deeply clone from
     */
    constructor(_value?: RecursivePartial<UpdateSettingsReq.AsObject>);
    get settings(): protoPubV1Models013.Settings | undefined;
    set settings(value: protoPubV1Models013.Settings | undefined);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
     ...
     * Cast message to standard JavaScript object (all non-primitive values are deeply cloned)
     */
    toObject(): UpdateSettingsReq.AsObject;
    /**
     * Convenience method to support JSON.stringify(message), replicates the structure of toObject()
     */
    toJSON(): UpdateSettingsReq.AsObject;
    /**
     * Cast message to JSON using protobuf JSON notation: https://developers.google.com/protocol-buffers/docs/proto3#json
     * Attention: output differs from toObject() e.g. enums are represented as names and not as numbers, Timestamp is an ISO Date string format etc.
     * If the message itself or some of descendant messages is google.protobuf.Any, you MUST provide a message pool as options. If not, the messagePool is not required
     */
    toProtobufJSON(options?: ToProtobufJSONOptions): UpdateSettingsReq.AsProtobufJSON;
}
export declare module UpdateSettingsReq {
    /**
     * Standard JavaScript object representation for UpdateSettingsReq
     */
    interface AsObject {
        settings?: protoPubV1Models013.Settings.AsObject;
    }
    /**
     * Protobuf JSON representation for UpdateSettingsReq
     */
    interface AsProtobufJSON {
        settings?: protoPubV1Models013.Settings.AsProtobufJSON | null;
    }
}
/**
 * Message implementation for proto.pub.v1.query.UpdateSettingsRes
 */
export declare class UpdateSettingsRes implements GrpcMessage {
    static id: string;
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
    static deserializeBinary(bytes: ByteSource): UpdateSettingsRes;
    /**
     * Check all the properties and set default protobuf values if necessary
     * @param _instance message instance
     */
    static refineValues(_instance: UpdateSettingsRes): void;
    /**
     * Deserializes / reads binary message into message instance using provided binary reader
     * @param _instance message instance
     * @param _reader binary reader instance
     */
    static deserializeBinaryFromReader(_instance: UpdateSettingsRes, _reader: BinaryReader): void;
    /**
     * Serializes a message to binary format using provided binary reader
     * @param _instance message instance
     * @param _writer binary writer instance
     */
    static serializeBinaryToWriter(_instance: UpdateSettingsRes, _writer: BinaryWriter): void;
    private _settings?;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
     * @param _value initial values object or instance of UpdateSettingsRes to deeply clone from
     */
    constructor(_value?: RecursivePartial<UpdateSettingsRes.AsObject>);
    get settings(): protoPubV1Models013.Settings | undefined;
    set settings(value: protoPubV1Models013.Settings | undefined);
    /**
     * Serialize message to binary data
     ...
     * Cast message to standard JavaScript object (all non-primitive values are deeply cloned)
     */
    toObject(): UpdateSettingsRes.AsObject;
    /**
     * Convenience method to support JSON.stringify(message), replicates the structure of toObject()
     */
    toJSON(): UpdateSettingsRes.AsObject;
    /**
     * Cast message to JSON using protobuf JSON notation: https://developers.google.com/protocol-buffers/docs/proto3#json
     * Attention: output differs from toObject() e.g. enums are represented as names and not as numbers, Timestamp is an ISO Date string format etc.
     * If the message itself or some of descendant messages is google.protobuf.Any, you MUST provide a message pool as options. If not, the messagePool is not required
     */
    toProtobufJSON(options?: ToProtobufJSONOptions): UpdateSettingsRes.AsProtobufJSON;
}
export declare module UpdateSettingsRes {
    /**
     * Standard JavaScript object representation for UpdateSettingsRes
     */
    interface AsObject {
        settings?: protoPubV1Models013.Settings.AsObject;
    }
    /**
     * Protobuf JSON representation for UpdateSettingsRes
     */
    interface AsProtobufJSON {
        settings?: protoPubV1Models013.Settings.AsProtobufJSON | null;
    }
...
/**
 * Message implementation for proto.pub.v1.query.GetSettingsReq
 */
export declare class GetSettingsReq implements GrpcMessage {
    static id: string;
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
    static deserializeBinary(bytes: ByteSource): GetSettingsReq;
    /**
     * Check all the properties and set default protobuf values if necessary
     * @param _instance message instance
     */
    static refineValues(_instance: GetSettingsReq): void;
    /**
     * Deserializes / reads binary message into message instance using provided binary reader
     * @param _instance message instance
     * @param _reader binary reader instance
     */
    static deserializeBinaryFromReader(_instance: GetSettingsReq, _reader: BinaryReader): void;
    /**
     * Serializes a message to binary format using provided binary reader
     * @param _instance message instance
     * @param _writer binary writer instance
     */
    static serializeBinaryToWriter(_instance: GetSettingsReq, _writer: BinaryWriter): void;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
     * @param _value initial values object or instance of GetSettingsReq to deeply clone from
     */
    constructor(_value?: RecursivePartial<GetSettingsReq.AsObject>);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
     ...
     * Cast message to standard JavaScript object (all non-primitive values are deeply cloned)
     */
    toObject(): GetSettingsReq.AsObject;
    /**
     * Convenience method to support JSON.stringify(message), replicates the structure of toObject()
     */
    toJSON(): GetSettingsReq.AsObject;
    /**
     * Cast message to JSON using protobuf JSON notation: https://developers.google.com/protocol-buffers/docs/proto3#json
     * Attention: output differs from toObject() e.g. enums are represented as names and not as numbers, Timestamp is an ISO Date string format etc.
     * If the message itself or some of descendant messages is google.protobuf.Any, you MUST provide a message pool as options. If not, the messagePool is not required
     */
    toProtobufJSON(options?: ToProtobufJSONOptions): GetSettingsReq.AsProtobufJSON;
}
export declare module GetSettingsReq {
    /**
     * Standard JavaScript object representation for GetSettingsReq
     */
    interface AsObject {
    }
    /**
     * Protobuf JSON representation for GetSettingsReq
     */
    interface AsProtobufJSON {
    }
}
/**
 * Message implementation for proto.pub.v1.query.GetSettingsRes
 */
export declare class GetSettingsRes implements GrpcMessage {
    static id: string;
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
    static deserializeBinary(bytes: ByteSource): GetSettingsRes;
    /**
     * Check all the properties and set default protobuf values if necessary
     * @param _instance message instance
     */
    static refineValues(_instance: GetSettingsRes): void;
    /**
     * Deserializes / reads binary message into message instance using provided binary reader
     * @param _instance message instance
     * @param _reader binary reader instance
     */
    static deserializeBinaryFromReader(_instance: GetSettingsRes, _reader: BinaryReader): void;
    /**
     * Serializes a message to binary format using provided binary reader
     * @param _instance message instance
     * @param _writer binary writer instance
     */
    static serializeBinaryToWriter(_instance: GetSettingsRes, _writer: BinaryWriter): void;
    private _settings?;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
     * @param _value initial values object or instance of GetSettingsRes to deeply clone from
     */
    constructor(_value?: RecursivePartial<GetSettingsRes.AsObject>);
    get settings(): protoPubV1Models013.Settings | undefined;
    set settings(value: protoPubV1Models013.Settings | undefined);
    /**
     * Serialize message to binary data
     ...
     * Cast message to standard JavaScript object (all non-primitive values are deeply cloned)
     */
    toObject(): GetSettingsRes.AsObject;
    /**
     * Convenience method to support JSON.stringify(message), replicates the structure of toObject()
     */
    toJSON(): GetSettingsRes.AsObject;
    /**
     * Cast message to JSON using protobuf JSON notation: https://developers.google.com/protocol-buffers/docs/proto3#json
     * Attention: output differs from toObject() e.g. enums are represented as names and not as numbers, Timestamp is an ISO Date string format etc.
     * If the message itself or some of descendant messages is google.protobuf.Any, you MUST provide a message pool as options. If not, the messagePool is not required
     */
    toProtobufJSON(options?: ToProtobufJSONOptions): GetSettingsRes.AsProtobufJSON;
}
export declare module GetSettingsRes {
    /**
     * Standard JavaScript object representation for GetSettingsRes
     */
    interface AsObject {
        settings?: protoPubV1Models013.Settings.AsObject;
    }
    /**
     * Protobuf JSON representation for GetSettingsRes
     */
    interface AsProtobufJSON {
        settings?: protoPubV1Models013.Settings.AsProtobufJSON | null;
    }
