 ...
 */
export declare class BlockReq implements GrpcMessage {
    static id: string;
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
    static deserializeBinary(bytes: ByteSource): BlockReq;
    /**
     * Check all the properties and set default protobuf values if necessary
     * @param _instance message instance
     */
    static refineValues(_instance: BlockReq): void;
    /**
     * Deserializes / reads binary message into message instance using provided binary reader
     * @param _instance message instance
     * @param _reader binary reader instance
     */
    static deserializeBinaryFromReader(_instance: BlockReq, _reader: BinaryReader): void;
    /**
     * Serializes a message to binary format using provided binary reader
     * @param _instance message instance
     * @param _writer binary writer instance
     */
    static serializeBinaryToWriter(_instance: BlockReq, _writer: BinaryWriter): void;
    private _uid?;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
     * @param _value initial values object or instance of BlockReq to deeply clone from
     */
    constructor(_value?: RecursivePartial<BlockReq.AsObject>);
    get uid(): protoPubV1Models000.Uid | undefined;
    set uid(value: protoPubV1Models000.Uid | undefined);
    /**
     * Serialize message to binary data
     ...
     * Cast message to standard JavaScript object (all non-primitive values are deeply cloned)
     */
    toObject(): BlockReq.AsObject;
    /**
     * Convenience method to support JSON.stringify(message), replicates the structure of toObject()
     */
    toJSON(): BlockReq.AsObject;
    /**
     * Cast message to JSON using protobuf JSON notation: https://developers.google.com/protocol-buffers/docs/proto3#json
     * Attention: output differs from toObject() e.g. enums are represented as names and not as numbers, Timestamp is an ISO Date string format etc.
     * If the message itself or some of descendant messages is google.protobuf.Any, you MUST provide a message pool as options. If not, the messagePool is not required
     */
    toProtobufJSON(options?: ToProtobufJSONOptions): BlockReq.AsProtobufJSON;
}
export declare module BlockReq {
    /**
     * Standard JavaScript object representation for BlockReq
     */
    interface AsObject {
        uid?: protoPubV1Models000.Uid.AsObject;
    }
    /**
     * Protobuf JSON representation for BlockReq
     */
    interface AsProtobufJSON {
        uid?: protoPubV1Models000.Uid.AsProtobufJSON | null;
    }
 ...
 */
export declare class BlockRes implements GrpcMessage {
    static id: string;
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
    static deserializeBinary(bytes: ByteSource): BlockRes;
    /**
     * Check all the properties and set default protobuf values if necessary
     * @param _instance message instance
     */
    static refineValues(_instance: BlockRes): void;
    /**
     * Deserializes / reads binary message into message instance using provided binary reader
     * @param _instance message instance
     * @param _reader binary reader instance
     */
    static deserializeBinaryFromReader(_instance: BlockRes, _reader: BinaryReader): void;
    /**
     * Serializes a message to binary format using provided binary reader
     * @param _instance message instance
     * @param _writer binary writer instance
     */
    static serializeBinaryToWriter(_instance: BlockRes, _writer: BinaryWriter): void;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
     * @param _value initial values object or instance of BlockRes to deeply clone from
     */
    constructor(_value?: RecursivePartial<BlockRes.AsObject>);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
     ...
     * Cast message to standard JavaScript object (all non-primitive values are deeply cloned)
     */
    toObject(): BlockRes.AsObject;
    /**
     * Convenience method to support JSON.stringify(message), replicates the structure of toObject()
     */
    toJSON(): BlockRes.AsObject;
    /**
     * Cast message to JSON using protobuf JSON notation: https://developers.google.com/protocol-buffers/docs/proto3#json
     * Attention: output differs from toObject() e.g. enums are represented as names and not as numbers, Timestamp is an ISO Date string format etc.
     * If the message itself or some of descendant messages is google.protobuf.Any, you MUST provide a message pool as options. If not, the messagePool is not required
     */
    toProtobufJSON(options?: ToProtobufJSONOptions): BlockRes.AsProtobufJSON;
}
export declare module BlockRes {
    /**
     * Standard JavaScript object representation for BlockRes
     */
    interface AsObject {
    }
    /**
     * Protobuf JSON representation for BlockRes
     */
    interface AsProtobufJSON {
    }
}
 ...
 */
export declare class UnblockReq implements GrpcMessage {
    static id: string;
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
    static deserializeBinary(bytes: ByteSource): UnblockReq;
    /**
     * Check all the properties and set default protobuf values if necessary
     * @param _instance message instance
     */
    static refineValues(_instance: UnblockReq): void;
    /**
     * Deserializes / reads binary message into message instance using provided binary reader
     * @param _instance message instance
     * @param _reader binary reader instance
     */
    static deserializeBinaryFromReader(_instance: UnblockReq, _reader: BinaryReader): void;
    /**
     * Serializes a message to binary format using provided binary reader
     * @param _instance message instance
     * @param _writer binary writer instance
     */
    static serializeBinaryToWriter(_instance: UnblockReq, _writer: BinaryWriter): void;
    private _uid?;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
     * @param _value initial values object or instance of UnblockReq to deeply clone from
     */
    constructor(_value?: RecursivePartial<UnblockReq.AsObject>);
    get uid(): protoPubV1Models000.Uid | undefined;
    set uid(value: protoPubV1Models000.Uid | undefined);
    /**
     * Serialize message to binary data
     ...
     * Cast message to standard JavaScript object (all non-primitive values are deeply cloned)
     */
    toObject(): UnblockReq.AsObject;
    /**
     * Convenience method to support JSON.stringify(message), replicates the structure of toObject()
     */
    toJSON(): UnblockReq.AsObject;
    /**
     * Cast message to JSON using protobuf JSON notation: https://developers.google.com/protocol-buffers/docs/proto3#json
     * Attention: output differs from toObject() e.g. enums are represented as names and not as numbers, Timestamp is an ISO Date string format etc.
     * If the message itself or some of descendant messages is google.protobuf.Any, you MUST provide a message pool as options. If not, the messagePool is not required
     */
    toProtobufJSON(options?: ToProtobufJSONOptions): UnblockReq.AsProtobufJSON;
}
export declare module UnblockReq {
    /**
     * Standard JavaScript object representation for UnblockReq
     */
    interface AsObject {
        uid?: protoPubV1Models000.Uid.AsObject;
    }
    /**
     * Protobuf JSON representation for UnblockReq
     */
    interface AsProtobufJSON {
        uid?: protoPubV1Models000.Uid.AsProtobufJSON | null;
    }
 ...
 */
export declare class UnblockRes implements GrpcMessage {
    static id: string;
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
    static deserializeBinary(bytes: ByteSource): UnblockRes;
    /**
     * Check all the properties and set default protobuf values if necessary
     * @param _instance message instance
     */
    static refineValues(_instance: UnblockRes): void;
    /**
     * Deserializes / reads binary message into message instance using provided binary reader
     * @param _instance message instance
     * @param _reader binary reader instance
     */
    static deserializeBinaryFromReader(_instance: UnblockRes, _reader: BinaryReader): void;
    /**
     * Serializes a message to binary format using provided binary reader
     * @param _instance message instance
     * @param _writer binary writer instance
     */
    static serializeBinaryToWriter(_instance: UnblockRes, _writer: BinaryWriter): void;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
     * @param _value initial values object or instance of UnblockRes to deeply clone from
     */
    constructor(_value?: RecursivePartial<UnblockRes.AsObject>);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
     ...
     * Cast message to standard JavaScript object (all non-primitive values are deeply cloned)
     */
    toObject(): UnblockRes.AsObject;
    /**
     * Convenience method to support JSON.stringify(message), replicates the structure of toObject()
     */
    toJSON(): UnblockRes.AsObject;
    /**
     * Cast message to JSON using protobuf JSON notation: https://developers.google.com/protocol-buffers/docs/proto3#json
     * Attention: output differs from toObject() e.g. enums are represented as names and not as numbers, Timestamp is an ISO Date string format etc.
     * If the message itself or some of descendant messages is google.protobuf.Any, you MUST provide a message pool as options. If not, the messagePool is not required
     */
    toProtobufJSON(options?: ToProtobufJSONOptions): UnblockRes.AsProtobufJSON;
}
export declare module UnblockRes {
    /**
     * Standard JavaScript object representation for UnblockRes
     */
    interface AsObject {
    }
    /**
     * Protobuf JSON representation for UnblockRes
     */
    interface AsProtobufJSON {
    }
}
 ...
 */
export declare class FetchMetaReq implements GrpcMessage {
    static id: string;
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
    static deserializeBinary(bytes: ByteSource): FetchMetaReq;
    /**
     * Check all the properties and set default protobuf values if necessary
     * @param _instance message instance
     */
    static refineValues(_instance: FetchMetaReq): void;
    /**
     * Deserializes / reads binary message into message instance using provided binary reader
     * @param _instance message instance
     * @param _reader binary reader instance
     */
    static deserializeBinaryFromReader(_instance: FetchMetaReq, _reader: BinaryReader): void;
    /**
     * Serializes a message to binary format using provided binary reader
     * @param _instance message instance
     * @param _writer binary writer instance
     */
    static serializeBinaryToWriter(_instance: FetchMetaReq, _writer: BinaryWriter): void;
    private _roomUid?;
    private _pointer?;
    private _year?;
    private _group?;
     ...
     */
    constructor(_value?: RecursivePartial<FetchMetaReq.AsObject>);
    get roomUid(): protoPubV1Models000.Uid | undefined;
    set roomUid(value: protoPubV1Models000.Uid | undefined);
    get pointer(): string | undefined;
    set pointer(value: string | undefined);
    get year(): number | undefined;
    set year(value: number | undefined);
    get group(): FetchMetaReq.Group | undefined;
    set group(value: FetchMetaReq.Group | undefined);
    get fetchingDirectionType(): FetchMetaReq.Direction | undefined;
    set fetchingDirectionType(value: FetchMetaReq.Direction | undefined);
    get limit(): number | undefined;
    set limit(value: number | undefined);
    /**
     * Serialize message to binary data
     ...
     * Cast message to standard JavaScript object (all non-primitive values are deeply cloned)
     */
    toObject(): FetchMetaReq.AsObject;
    /**
     * Convenience method to support JSON.stringify(message), replicates the structure of toObject()
     */
    toJSON(): FetchMetaReq.AsObject;
    /**
     * Cast message to JSON using protobuf JSON notation: https://developers.google.com/protocol-buffers/docs/proto3#json
     * Attention: output differs from toObject() e.g. enums are represented as names and not as numbers, Timestamp is an ISO Date string format etc.
     * If the message itself or some of descendant messages is google.protobuf.Any, you MUST provide a message pool as options. If not, the messagePool is not required
     */
    toProtobufJSON(options?: ToProtobufJSONOptions): FetchMetaReq.AsProtobufJSON;
}
export declare module FetchMetaReq {
    /**
     * Standard JavaScript object representation for FetchMetaReq
     */
    interface AsObject {
        roomUid?: protoPubV1Models000.Uid.AsObject;
        pointer?: string;
        year?: number;
        group?: FetchMetaReq.Group;
        fetchingDirectionType?: FetchMetaReq.Direction;
        limit?: number;
    }
    /**
     * Protobuf JSON representation for FetchMetaReq
     */
    interface AsProtobufJSON {
        roomUid?: protoPubV1Models000.Uid.AsProtobufJSON | null;
        pointer?: string;
 ...
 */
export declare class FetchMetaRes implements GrpcMessage {
    static id: string;
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
    static deserializeBinary(bytes: ByteSource): FetchMetaRes;
    /**
     * Check all the properties and set default protobuf values if necessary
     * @param _instance message instance
     */
    static refineValues(_instance: FetchMetaRes): void;
    /**
     * Deserializes / reads binary message into message instance using provided binary reader
     * @param _instance message instance
     * @param _reader binary reader instance
     */
    static deserializeBinaryFromReader(_instance: FetchMetaRes, _reader: BinaryReader): void;
    /**
     * Serializes a message to binary format using provided binary reader
     * @param _instance message instance
     * @param _writer binary writer instance
     */
    static serializeBinaryToWriter(_instance: FetchMetaRes, _writer: BinaryWriter): void;
    private _metaList?;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
     * @param _value initial values object or instance of FetchMetaRes to deeply clone from
     */
    constructor(_value?: RecursivePartial<FetchMetaRes.AsObject>);
     ...
     * Cast message to standard JavaScript object (all non-primitive values are deeply cloned)
     */
    toObject(): FetchMetaRes.AsObject;
    /**
     * Convenience method to support JSON.stringify(message), replicates the structure of toObject()
     */
    toJSON(): FetchMetaRes.AsObject;
    /**
     * Cast message to JSON using protobuf JSON notation: https://developers.google.com/protocol-buffers/docs/proto3#json
     * Attention: output differs from toObject() e.g. enums are represented as names and not as numbers, Timestamp is an ISO Date string format etc.
     * If the message itself or some of descendant messages is google.protobuf.Any, you MUST provide a message pool as options. If not, the messagePool is not required
     */
    toProtobufJSON(options?: ToProtobufJSONOptions): FetchMetaRes.AsProtobufJSON;
}
export declare module FetchMetaRes {
    /**
     * Standard JavaScript object representation for FetchMetaRes
     */
    interface AsObject {
        metaList?: protoPubV1Models015.Meta.AsObject[];
    }
    /**
     * Protobuf JSON representation for FetchMetaRes
     */
    interface AsProtobufJSON {
