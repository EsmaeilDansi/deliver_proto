...
export declare class CallEvent implements GrpcMessage {
    ...
    private _newStatus?;
    private _callType?;
    private _endOfCallTime?;
    private _callDuration?;
    private _memberOrCallOwnerPvp?;
    /**
    ...
    get newStatus(): CallEvent.CallStatus | undefined;
    set newStatus(value: CallEvent.CallStatus | undefined);
    get callType(): CallEvent.CallType | undefined;
    set callType(value: CallEvent.CallType | undefined);
    get endOfCallTime(): string | undefined;
    set endOfCallTime(value: string | undefined);
    get callDuration(): string | undefined;
    set callDuration(value: string | undefined);
    get memberOrCallOwnerPvp(): protoPubV1Models001.Uid | undefined;
    set memberOrCallOwnerPvp(value: protoPubV1Models001.Uid | undefined);
    /**
...
export declare module CallEvent {
    ...
    interface AsObject {
        id?: string;
        newStatus?: CallEvent.CallStatus;
        callType?: CallEvent.CallType;
        endOfCallTime?: string;
        callDuration?: string;
        memberOrCallOwnerPvp?: protoPubV1Models001.Uid.AsObject;
    }
    /**
    ...
    interface AsProtobufJSON {
        ...
        endOfCallTime?: string;
        callDuration?: string;
        memberOrCallOwnerPvp?: protoPubV1Models001.Uid.AsProtobufJSON | null;
    }
    enum CallStatus {
        CREATED = 0,
        IS_RINGING = 1,
