...
export declare module MessageBrief {
    ...
    enum MessageTypes {
        ...
        CALL_DECLINED = 16,
        TABLE = 17,
        PE_AS_NEW_CONTACT_ADDED = 18,
        PE_BS_BOT_NOT_RESPONDING = 19,
        PE_MS_KICK_USER = 20,
        PE_MS_ADD_USER = 21,
        PE_MS_PIN_MESSAGE = 22,
        PE_MS_NAME_CHANGED = 23,
        PE_MS_AVATAR_CHANGED = 24,
        PE_MS_MUC_CREATED = 25,
        PE_MS_LEAVE_USER = 26,
        PE_MS_JOINED_USER = 27,
        PE_MS_DELETED = 28,
        PDT_PHONE_NUMBER = 29,
        PDT_USERNAME = 30,
        PDT_EMAIL = 31,
