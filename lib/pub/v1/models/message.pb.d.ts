...
export declare class Message implements GrpcMessage {
    ...
    get paymentInformation(): protoPubV1Models006.PaymentInformation | undefined;
    set paymentInformation(value: protoPubV1Models006.PaymentInformation | undefined);
...
export declare module Message {
    ...
    interface AsObject {
        ...
        paymentInformation?: protoPubV1Models006.PaymentInformation.AsObject;
    }
    /**
    ...
    interface AsProtobufJSON {
        ...
        paymentInformation?: protoPubV1Models006.PaymentInformation.AsProtobufJSON | null;
    }
    enum TypeCase {
        none = 0,
        text = 1,
