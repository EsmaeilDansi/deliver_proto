...
export declare class Announcement implements GrpcMessage {
    ...
    get forcedToShow(): boolean | undefined;
    set forcedToShow(value: boolean | undefined);
...
export declare class AnnouncementDetailsViewConfiguration implements GrpcMessage {
    ...
    private _clickableSince?;
    private _clickableUntil?;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
    ...
    get clickableSince(): string | undefined;
    set clickableSince(value: string | undefined);
    get clickableUntil(): string | undefined;
    set clickableUntil(value: string | undefined);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
