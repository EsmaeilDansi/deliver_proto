...
export declare class UserAsContact implements GrpcMessage {
    ...
    private _email?;
    private _realFirstName?;
    private _realLastName?;
    /**
    ...
    get realFirstName(): string | undefined;
    set realFirstName(value: string | undefined);
    get realLastName(): string | undefined;
    set realLastName(value: string | undefined);
    /**
