...
export declare class InlineKeyboardButtonCallback implements GrpcMessage {
    ...
    get pinCodeSettings(): protoPubV1Models000.PinCodeSettings | undefined;
    set pinCodeSettings(value: protoPubV1Models000.PinCodeSettings | undefined);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
...
export declare module InlineKeyboardButtonCallback {
    ...
    interface AsObject {
        data?: string;
        pinCodeSettings?: protoPubV1Models000.PinCodeSettings.AsObject;
    }
    /**
    ...
    interface AsProtobufJSON {
        data?: string;
        pinCodeSettings?: protoPubV1Models000.PinCodeSettings.AsProtobufJSON | null;
    }
}
/**
