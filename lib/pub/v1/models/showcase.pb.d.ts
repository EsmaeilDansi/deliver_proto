...
export declare class BannerCase implements GrpcMessage {
    ...
    get bannerImg(): protoPubV1Models002.File | undefined;
    set bannerImg(value: protoPubV1Models002.File | undefined);
...
export declare module BannerCase {
     ...
     */
    interface AsObject {
        bannerImg?: protoPubV1Models002.File.AsObject;
     ...
     */
    interface AsProtobufJSON {
        bannerImg?: protoPubV1Models002.File.AsProtobufJSON | null;
...
export declare class UrlCase implements GrpcMessage {
    ...
    get name(): protoPubV1Models002.File | undefined;
    set name(value: protoPubV1Models002.File | undefined);
    get description(): protoPubV1Models002.File | undefined;
    set description(value: protoPubV1Models002.File | undefined);
...
export declare module UrlCase {
     ...
     */
    interface AsObject {
        name?: protoPubV1Models002.File.AsObject;
        description?: protoPubV1Models002.File.AsObject;
     ...
     */
    interface AsProtobufJSON {
        name?: protoPubV1Models002.File.AsProtobufJSON | null;
        description?: protoPubV1Models002.File.AsProtobufJSON | null;
