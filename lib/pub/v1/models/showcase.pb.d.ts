...
export declare class BotCallback implements GrpcMessage {
    ...
    private _bot?;
    private _data?;
    private _isPinCodeNeeded?;
    private _pinCodeLength?;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
    ...
    get isPinCodeNeeded(): boolean | undefined;
    set isPinCodeNeeded(value: boolean | undefined);
    get pinCodeLength(): number | undefined;
    set pinCodeLength(value: number | undefined);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
