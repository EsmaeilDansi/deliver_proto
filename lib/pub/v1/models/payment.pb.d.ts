...
export declare class Payment implements GrpcMessage {
    ...
    set paymentProvider(value: PaymentProvider[] | undefined);
...
export declare module Payment {
    ...
    interface AsObject {
        ...
        paymentProvider?: PaymentProvider.AsObject[];
        createAt?: string;
        expireAt?: string;
    }
    /**
    ...
    interface AsProtobufJSON {
        ...
        currency?: string;
        paymentProvider?: PaymentProvider.AsProtobufJSON[] | null;
        createAt?: string;
        expireAt?: string;
    }
}
 ...
 */
export declare class PaymentProvider implements GrpcMessage {
    static id: string;
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
    static deserializeBinary(bytes: ByteSource): PaymentProvider;
    /**
     * Check all the properties and set default protobuf values if necessary
     * @param _instance message instance
     */
    static refineValues(_instance: PaymentProvider): void;
    /**
     * Deserializes / reads binary message into message instance using provided binary reader
     * @param _instance message instance
     * @param _reader binary reader instance
     */
    static deserializeBinaryFromReader(_instance: PaymentProvider, _reader: BinaryReader): void;
    /**
     * Serializes a message to binary format using provided binary reader
     * @param _instance message instance
     * @param _writer binary writer instance
     */
    static serializeBinaryToWriter(_instance: PaymentProvider, _writer: BinaryWriter): void;
    private _paymentProviderType?;
     ...
     */
    constructor(_value?: RecursivePartial<PaymentProvider.AsObject>);
    get paymentProviderType(): PaymentProviderType | undefined;
    set paymentProviderType(value: PaymentProviderType | undefined);
     ...
     * Cast message to standard JavaScript object (all non-primitive values are deeply cloned)
     */
    toObject(): PaymentProvider.AsObject;
    /**
     * Convenience method to support JSON.stringify(message), replicates the structure of toObject()
     */
    toJSON(): PaymentProvider.AsObject;
    /**
     * Cast message to JSON using protobuf JSON notation: https://developers.google.com/protocol-buffers/docs/proto3#json
     * Attention: output differs from toObject() e.g. enums are represented as names and not as numbers, Timestamp is an ISO Date string format etc.
     * If the message itself or some of descendant messages is google.protobuf.Any, you MUST provide a message pool as options. If not, the messagePool is not required
     */
    toProtobufJSON(options?: ToProtobufJSONOptions): PaymentProvider.AsProtobufJSON;
}
export declare module PaymentProvider {
    /**
     * Standard JavaScript object representation for PaymentProvider
     */
    interface AsObject {
    ...
    /**
     * Protobuf JSON representation for PaymentProvider
     */
    interface AsProtobufJSON {
...
export declare class RequiredPaymentIdentityInfo implements GrpcMessage {
    ...
    private _isNationalCodeRequired?;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
    ...
    get isNationalCodeRequired(): boolean | undefined;
    set isNationalCodeRequired(value: boolean | undefined);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
