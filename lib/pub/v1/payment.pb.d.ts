 ...
 */
export declare class GetPaymentInformationReq implements GrpcMessage {
    static id: string;
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
    static deserializeBinary(bytes: ByteSource): GetPaymentInformationReq;
    /**
     * Check all the properties and set default protobuf values if necessary
     * @param _instance message instance
     */
    static refineValues(_instance: GetPaymentInformationReq): void;
    /**
     * Deserializes / reads binary message into message instance using provided binary reader
     * @param _instance message instance
     * @param _reader binary reader instance
     */
    static deserializeBinaryFromReader(_instance: GetPaymentInformationReq, _reader: BinaryReader): void;
    /**
     * Serializes a message to binary format using provided binary reader
     * @param _instance message instance
     * @param _writer binary writer instance
     */
    static serializeBinaryToWriter(_instance: GetPaymentInformationReq, _writer: BinaryWriter): void;
    private _paymentId?;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
     * @param _value initial values object or instance of GetPaymentInformationReq to deeply clone from
     */
    constructor(_value?: RecursivePartial<GetPaymentInformationReq.AsObject>);
    get paymentId(): string | undefined;
    set paymentId(value: string | undefined);
    /**
     * Serialize message to binary data
     ...
     * Cast message to standard JavaScript object (all non-primitive values are deeply cloned)
     */
    toObject(): GetPaymentInformationReq.AsObject;
    /**
     * Convenience method to support JSON.stringify(message), replicates the structure of toObject()
     */
    toJSON(): GetPaymentInformationReq.AsObject;
    /**
     * Cast message to JSON using protobuf JSON notation: https://developers.google.com/protocol-buffers/docs/proto3#json
     * Attention: output differs from toObject() e.g. enums are represented as names and not as numbers, Timestamp is an ISO Date string format etc.
     * If the message itself or some of descendant messages is google.protobuf.Any, you MUST provide a message pool as options. If not, the messagePool is not required
     */
    toProtobufJSON(options?: ToProtobufJSONOptions): GetPaymentInformationReq.AsProtobufJSON;
}
export declare module GetPaymentInformationReq {
    /**
     * Standard JavaScript object representation for GetPaymentInformationReq
     */
    interface AsObject {
        paymentId?: string;
    }
    /**
     * Protobuf JSON representation for GetPaymentInformationReq
     */
    interface AsProtobufJSON {
        paymentId?: string;
    }
 ...
 */
export declare class GetPaymentInformationRes implements GrpcMessage {
    static id: string;
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
    static deserializeBinary(bytes: ByteSource): GetPaymentInformationRes;
    /**
     * Check all the properties and set default protobuf values if necessary
     * @param _instance message instance
     */
    static refineValues(_instance: GetPaymentInformationRes): void;
    /**
     * Deserializes / reads binary message into message instance using provided binary reader
     * @param _instance message instance
     * @param _reader binary reader instance
     */
    static deserializeBinaryFromReader(_instance: GetPaymentInformationRes, _reader: BinaryReader): void;
    /**
     * Serializes a message to binary format using provided binary reader
     * @param _instance message instance
     * @param _writer binary writer instance
     */
    static serializeBinaryToWriter(_instance: GetPaymentInformationRes, _writer: BinaryWriter): void;
     ...
     */
    constructor(_value?: RecursivePartial<GetPaymentInformationRes.AsObject>);
    get paymentInformation(): protoPubV1Models002.PaymentInformation | undefined;
    set paymentInformation(value: protoPubV1Models002.PaymentInformation | undefined);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
     ...
     * Cast message to standard JavaScript object (all non-primitive values are deeply cloned)
     */
    toObject(): GetPaymentInformationRes.AsObject;
    /**
     * Convenience method to support JSON.stringify(message), replicates the structure of toObject()
     */
    toJSON(): GetPaymentInformationRes.AsObject;
    /**
     * Cast message to JSON using protobuf JSON notation: https://developers.google.com/protocol-buffers/docs/proto3#json
     * Attention: output differs from toObject() e.g. enums are represented as names and not as numbers, Timestamp is an ISO Date string format etc.
     * If the message itself or some of descendant messages is google.protobuf.Any, you MUST provide a message pool as options. If not, the messagePool is not required
     */
    toProtobufJSON(options?: ToProtobufJSONOptions): GetPaymentInformationRes.AsProtobufJSON;
}
export declare module GetPaymentInformationRes {
    /**
     * Standard JavaScript object representation for GetPaymentInformationRes
     */
    interface AsObject {
        paymentInformation?: protoPubV1Models002.PaymentInformation.AsObject;
    }
    /**
     * Protobuf JSON representation for GetPaymentInformationRes
     */
    interface AsProtobufJSON {
        paymentInformation?: protoPubV1Models002.PaymentInformation.AsProtobufJSON | null;
    }
}
