 ...
 */
export declare class AddMemberToLocalMuc implements GrpcMessage {
    static id: string;
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
    static deserializeBinary(bytes: ByteSource): AddMemberToLocalMuc;
    /**
     * Check all the properties and set default protobuf values if necessary
     * @param _instance message instance
     */
    static refineValues(_instance: AddMemberToLocalMuc): void;
    /**
     * Deserializes / reads binary message into message instance using provided binary reader
     * @param _instance message instance
     * @param _reader binary reader instance
     */
    static deserializeBinaryFromReader(_instance: AddMemberToLocalMuc, _reader: BinaryReader): void;
    /**
     * Serializes a message to binary format using provided binary reader
     * @param _instance message instance
     * @param _writer binary writer instance
     */
    static serializeBinaryToWriter(_instance: AddMemberToLocalMuc, _writer: BinaryWriter): void;
    private _mucUid?;
    private _oldMembers?;
    private _newMembers?;
    private _name?;
     ...
     */
    constructor(_value?: RecursivePartial<AddMemberToLocalMuc.AsObject>);
    get mucUid(): protoPubV1Models001.Uid | undefined;
    set mucUid(value: protoPubV1Models001.Uid | undefined);
    get oldMembers(): protoPubV1Models002.Member[] | undefined;
    set oldMembers(value: protoPubV1Models002.Member[] | undefined);
    get newMembers(): protoPubV1Models002.Member[] | undefined;
    set newMembers(value: protoPubV1Models002.Member[] | undefined);
    get name(): string | undefined;
    set name(value: string | undefined);
    get issuer(): protoPubV1Models002.Member | undefined;
    set issuer(value: protoPubV1Models002.Member | undefined);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
     ...
     * Cast message to standard JavaScript object (all non-primitive values are deeply cloned)
     */
    toObject(): AddMemberToLocalMuc.AsObject;
    /**
     * Convenience method to support JSON.stringify(message), replicates the structure of toObject()
     */
    toJSON(): AddMemberToLocalMuc.AsObject;
    /**
     * Cast message to JSON using protobuf JSON notation: https://developers.google.com/protocol-buffers/docs/proto3#json
     * Attention: output differs from toObject() e.g. enums are represented as names and not as numbers, Timestamp is an ISO Date string format etc.
     * If the message itself or some of descendant messages is google.protobuf.Any, you MUST provide a message pool as options. If not, the messagePool is not required
     */
    toProtobufJSON(options?: ToProtobufJSONOptions): AddMemberToLocalMuc.AsProtobufJSON;
}
export declare module AddMemberToLocalMuc {
    /**
     * Standard JavaScript object representation for AddMemberToLocalMuc
     */
    interface AsObject {
        mucUid?: protoPubV1Models001.Uid.AsObject;
        oldMembers?: protoPubV1Models002.Member.AsObject[];
        newMembers?: protoPubV1Models002.Member.AsObject[];
        name?: string;
        issuer?: protoPubV1Models002.Member.AsObject;
    }
    /**
     * Protobuf JSON representation for AddMemberToLocalMuc
     */
    interface AsProtobufJSON {
        mucUid?: protoPubV1Models001.Uid.AsProtobufJSON | null;
        oldMembers?: protoPubV1Models002.Member.AsProtobufJSON[] | null;
        newMembers?: protoPubV1Models002.Member.AsProtobufJSON[] | null;
        name?: string;
        issuer?: protoPubV1Models002.Member.AsProtobufJSON | null;
    }
}
/**
