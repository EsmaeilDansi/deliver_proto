...
export declare class Ping implements GrpcMessage {
    ...
    private _shouldTriggerActiveUser?;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
    ...
    get shouldTriggerActiveUser(): boolean | undefined;
    set shouldTriggerActiveUser(value: boolean | undefined);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
...
export declare module Ping {
    ...
    interface AsObject {
        ...
        shouldTriggerActiveUser?: boolean;
    }
    /**
