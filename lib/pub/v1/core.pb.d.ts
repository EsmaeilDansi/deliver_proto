...
export declare class Pong implements GrpcMessage {
    ...
    get lastMessageDeliveryAck(): protoPubV1Models016.MessageDeliveryAck | undefined;
    set lastMessageDeliveryAck(value: protoPubV1Models016.MessageDeliveryAck | undefined);
...
export declare module Pong {
    ...
    interface AsObject {
        ...
        lastMessageDeliveryAck?: protoPubV1Models016.MessageDeliveryAck.AsObject;
    ...
    interface AsProtobufJSON {
        ...
        lastMessageDeliveryAck?: protoPubV1Models016.MessageDeliveryAck.AsProtobufJSON | null;
        lastRoomMetadataUpdateTime?: string;
    }
...
export declare class RoomPresenceTypeChanged implements GrpcMessage {
    ...
    get presenceType(): protoPubV1Models017.PresenceType | undefined;
    set presenceType(value: protoPubV1Models017.PresenceType | undefined);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
...
export declare module RoomPresenceTypeChanged {
    ...
    interface AsObject {
        ...
        presenceType?: protoPubV1Models017.PresenceType;
    }
    /**
...
export declare class ServerPacket implements GrpcMessage {
    ...
    get message(): protoPubV1Models016.Message | undefined;
    set message(value: protoPubV1Models016.Message | undefined);
    ...
    get messageDeliveryAck(): protoPubV1Models016.MessageDeliveryAck | undefined;
    set messageDeliveryAck(value: protoPubV1Models016.MessageDeliveryAck | undefined);
...
export declare module ServerPacket {
    ...
    interface AsObject {
        ...
        message?: protoPubV1Models016.Message.AsObject;
        ...
        pong?: Pong.AsObject;
        messageDeliveryAck?: protoPubV1Models016.MessageDeliveryAck.AsObject;
    ...
    interface AsProtobufJSON {
        ...
        message?: protoPubV1Models016.Message.AsProtobufJSON | null;
        ...
        messageDeliveryAck?: protoPubV1Models016.MessageDeliveryAck.AsProtobufJSON | null;
...
export declare class ClientPacket implements GrpcMessage {
    ...
    get message(): protoPubV1Models016.MessageByClient | undefined;
    set message(value: protoPubV1Models016.MessageByClient | undefined);
    ...
    get localChatMessage(): protoPubV1Models016.LocalChatMessage | undefined;
    set localChatMessage(value: protoPubV1Models016.LocalChatMessage | undefined);
...
export declare module ClientPacket {
    ...
    interface AsObject {
        id?: string;
        message?: protoPubV1Models016.MessageByClient.AsObject;
        ...
        localChatMessage?: protoPubV1Models016.LocalChatMessage.AsObject;
    }
    /**
    ...
    interface AsProtobufJSON {
        id?: string;
        message?: protoPubV1Models016.MessageByClient.AsProtobufJSON | null;
        ...
        localChatMessage?: protoPubV1Models016.LocalChatMessage.AsProtobufJSON | null;
    }
    enum TypeCase {
        none = 0,
        message = 1,
