...
export declare class Pong implements GrpcMessage {
    ...
    private _lastRoomMetadataUpdateTime?;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
    ...
    get lastMessageDeliveryAck(): protoPubV1Models015.MessageDeliveryAck | undefined;
    set lastMessageDeliveryAck(value: protoPubV1Models015.MessageDeliveryAck | undefined);
    get lastRoomMetadataUpdateTime(): string | undefined;
    set lastRoomMetadataUpdateTime(value: string | undefined);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
...
export declare module Pong {
    ...
    interface AsObject {
        ...
        lastMessageDeliveryAck?: protoPubV1Models015.MessageDeliveryAck.AsObject;
        lastRoomMetadataUpdateTime?: string;
    }
    /**
    ...
    interface AsProtobufJSON {
        ...
        lastMessageDeliveryAck?: protoPubV1Models015.MessageDeliveryAck.AsProtobufJSON | null;
        lastRoomMetadataUpdateTime?: string;
    }
...
export declare class ServerPacket implements GrpcMessage {
    ...
    get message(): protoPubV1Models015.Message | undefined;
    set message(value: protoPubV1Models015.Message | undefined);
    get seen(): protoPubV1Models013.Seen | undefined;
    set seen(value: protoPubV1Models013.Seen | undefined);
    get activity(): protoPubV1Models014.Activity | undefined;
    set activity(value: protoPubV1Models014.Activity | undefined);
    ...
    get messageDeliveryAck(): protoPubV1Models015.MessageDeliveryAck | undefined;
    set messageDeliveryAck(value: protoPubV1Models015.MessageDeliveryAck | undefined);
    ...
    get callEvent(): protoPubV1Models010.CallEventV2 | undefined;
    set callEvent(value: protoPubV1Models010.CallEventV2 | undefined);
...
export declare module ServerPacket {
    ...
    interface AsObject {
        ...
        message?: protoPubV1Models015.Message.AsObject;
        seen?: protoPubV1Models013.Seen.AsObject;
        activity?: protoPubV1Models014.Activity.AsObject;
        ...
        pong?: Pong.AsObject;
        messageDeliveryAck?: protoPubV1Models015.MessageDeliveryAck.AsObject;
        callOffer?: protoPubV1Models010.CallOffer.AsObject;
        callAnswer?: protoPubV1Models010.CallAnswer.AsObject;
        callEvent?: protoPubV1Models010.CallEventV2.AsObject;
    ...
    interface AsProtobufJSON {
        ...
        message?: protoPubV1Models015.Message.AsProtobufJSON | null;
        seen?: protoPubV1Models013.Seen.AsProtobufJSON | null;
        activity?: protoPubV1Models014.Activity.AsProtobufJSON | null;
        ...
        messageDeliveryAck?: protoPubV1Models015.MessageDeliveryAck.AsProtobufJSON | null;
        callOffer?: protoPubV1Models010.CallOffer.AsProtobufJSON | null;
        callAnswer?: protoPubV1Models010.CallAnswer.AsProtobufJSON | null;
        callEvent?: protoPubV1Models010.CallEventV2.AsProtobufJSON | null;
...
export declare class ClientPacket implements GrpcMessage {
    ...
    get message(): protoPubV1Models015.MessageByClient | undefined;
    set message(value: protoPubV1Models015.MessageByClient | undefined);
    get seen(): protoPubV1Models013.SeenByClient | undefined;
    set seen(value: protoPubV1Models013.SeenByClient | undefined);
    get activity(): protoPubV1Models014.ActivityByClient | undefined;
    set activity(value: protoPubV1Models014.ActivityByClient | undefined);
    ...
    get callEvent(): protoPubV1Models010.CallEventV2ByClient | undefined;
    set callEvent(value: protoPubV1Models010.CallEventV2ByClient | undefined);
...
export declare module ClientPacket {
    ...
    interface AsObject {
        id?: string;
        message?: protoPubV1Models015.MessageByClient.AsObject;
        seen?: protoPubV1Models013.SeenByClient.AsObject;
        activity?: protoPubV1Models014.ActivityByClient.AsObject;
        ping?: Ping.AsObject;
        callOffer?: protoPubV1Models010.CallOfferByClient.AsObject;
        callAnswer?: protoPubV1Models010.CallAnswerByClient.AsObject;
        callEvent?: protoPubV1Models010.CallEventV2ByClient.AsObject;
    }
    /**
    ...
    interface AsProtobufJSON {
        id?: string;
        message?: protoPubV1Models015.MessageByClient.AsProtobufJSON | null;
        seen?: protoPubV1Models013.SeenByClient.AsProtobufJSON | null;
        activity?: protoPubV1Models014.ActivityByClient.AsProtobufJSON | null;
        ...
        callEvent?: protoPubV1Models010.CallEventV2ByClient.AsProtobufJSON | null;
    }
    enum TypeCase {
        none = 0,
        message = 1,
