...
export declare class GroupServiceClient {
    ...
    $raw: {
         ...
         * @returns Observable<GrpcEvent<thisProto.CreateGroupRes>>
         */
        createLocalGroup: (requestData: thisProto.CreateLocalGroupReq, requestMetadata?: GrpcMetadata) => Observable<GrpcEvent<thisProto.CreateGroupRes>>;
        /**
         ...
         */
        syncLocalGroup: (requestData: thisProto.SyncLocalGroupReq, requestMetadata?: GrpcMetadata) => Observable<GrpcEvent<thisProto.SyncLocalGroupRes>>;
        /**
         ...
         */
        addMemberToLocalMuc: (requestData: thisProto.AddMembersToLocalMucReq, requestMetadata?: GrpcMetadata) => Observable<GrpcEvent<thisProto.AddMembersToLocalMucRes>>;
    };
     ...
     * @returns Observable<thisProto.CreateGroupRes>
     */
    createLocalGroup(requestData: thisProto.CreateLocalGroupReq, requestMetadata?: GrpcMetadata): Observable<thisProto.CreateGroupRes>;
    /**
     * Unary call @/proto.pub.v1.group.GroupService/ModifyGroup
     *
     * @param requestMessage Request message
     ...
     */
    syncLocalGroup(requestData: thisProto.SyncLocalGroupReq, requestMetadata?: GrpcMetadata): Observable<thisProto.SyncLocalGroupRes>;
    /**
     * Unary call @/proto.pub.v1.group.GroupService/AddMemberToLocalMuc
     *
     * @param requestMessage Request message
     ...
     */
    addMemberToLocalMuc(requestData: thisProto.AddMembersToLocalMucReq, requestMetadata?: GrpcMetadata): Observable<thisProto.AddMembersToLocalMucRes>;
