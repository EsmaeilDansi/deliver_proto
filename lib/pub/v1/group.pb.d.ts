...
/**
 * Message implementation for proto.pub.v1.group.SyncLocalGroupReq
 */
export declare class SyncLocalGroupReq implements GrpcMessage {
    static id: string;
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
    static deserializeBinary(bytes: ByteSource): SyncLocalGroupReq;
    /**
     * Check all the properties and set default protobuf values if necessary
     * @param _instance message instance
     */
    static refineValues(_instance: SyncLocalGroupReq): void;
    /**
     * Deserializes / reads binary message into message instance using provided binary reader
     * @param _instance message instance
     * @param _reader binary reader instance
     */
    static deserializeBinaryFromReader(_instance: SyncLocalGroupReq, _reader: BinaryReader): void;
    /**
     * Serializes a message to binary format using provided binary reader
     * @param _instance message instance
     * @param _writer binary writer instance
     */
    static serializeBinaryToWriter(_instance: SyncLocalGroupReq, _writer: BinaryWriter): void;
    private _groupUid?;
    private _owner?;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
     * @param _value initial values object or instance of SyncLocalGroupReq to deeply clone from
     */
    constructor(_value?: RecursivePartial<SyncLocalGroupReq.AsObject>);
    get groupUid(): protoPubV1Models001.Uid | undefined;
    set groupUid(value: protoPubV1Models001.Uid | undefined);
     ...
     * Cast message to standard JavaScript object (all non-primitive values are deeply cloned)
     */
    toObject(): SyncLocalGroupReq.AsObject;
    /**
     * Convenience method to support JSON.stringify(message), replicates the structure of toObject()
     */
    toJSON(): SyncLocalGroupReq.AsObject;
    /**
     * Cast message to JSON using protobuf JSON notation: https://developers.google.com/protocol-buffers/docs/proto3#json
     * Attention: output differs from toObject() e.g. enums are represented as names and not as numbers, Timestamp is an ISO Date string format etc.
     * If the message itself or some of descendant messages is google.protobuf.Any, you MUST provide a message pool as options. If not, the messagePool is not required
     */
    toProtobufJSON(options?: ToProtobufJSONOptions): SyncLocalGroupReq.AsProtobufJSON;
}
export declare module SyncLocalGroupReq {
    /**
     * Standard JavaScript object representation for SyncLocalGroupReq
     */
    interface AsObject {
        groupUid?: protoPubV1Models001.Uid.AsObject;
        owner?: protoPubV1Models001.Uid.AsObject;
    }
    /**
     * Protobuf JSON representation for SyncLocalGroupReq
     */
    interface AsProtobufJSON {
        groupUid?: protoPubV1Models001.Uid.AsProtobufJSON | null;
        owner?: protoPubV1Models001.Uid.AsProtobufJSON | null;
    }
}
/**
 * Message implementation for proto.pub.v1.group.SyncLocalGroupRes
 */
export declare class SyncLocalGroupRes implements GrpcMessage {
    static id: string;
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
    static deserializeBinary(bytes: ByteSource): SyncLocalGroupRes;
    /**
     * Check all the properties and set default protobuf values if necessary
     * @param _instance message instance
     */
    static refineValues(_instance: SyncLocalGroupRes): void;
    /**
     * Deserializes / reads binary message into message instance using provided binary reader
     * @param _instance message instance
     * @param _reader binary reader instance
     */
    static deserializeBinaryFromReader(_instance: SyncLocalGroupRes, _reader: BinaryReader): void;
    /**
     * Serializes a message to binary format using provided binary reader
     * @param _instance message instance
     * @param _writer binary writer instance
     */
    static serializeBinaryToWriter(_instance: SyncLocalGroupRes, _writer: BinaryWriter): void;
    private _synced?;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
     * @param _value initial values object or instance of SyncLocalGroupRes to deeply clone from
     */
    constructor(_value?: RecursivePartial<SyncLocalGroupRes.AsObject>);
    get synced(): boolean | undefined;
    set synced(value: boolean | undefined);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
     ...
     * Cast message to standard JavaScript object (all non-primitive values are deeply cloned)
     */
    toObject(): SyncLocalGroupRes.AsObject;
    /**
     * Convenience method to support JSON.stringify(message), replicates the structure of toObject()
     */
    toJSON(): SyncLocalGroupRes.AsObject;
    /**
     * Cast message to JSON using protobuf JSON notation: https://developers.google.com/protocol-buffers/docs/proto3#json
     * Attention: output differs from toObject() e.g. enums are represented as names and not as numbers, Timestamp is an ISO Date string format etc.
     * If the message itself or some of descendant messages is google.protobuf.Any, you MUST provide a message pool as options. If not, the messagePool is not required
     */
    toProtobufJSON(options?: ToProtobufJSONOptions): SyncLocalGroupRes.AsProtobufJSON;
}
export declare module SyncLocalGroupRes {
    /**
     * Standard JavaScript object representation for SyncLocalGroupRes
     */
    interface AsObject {
        synced?: boolean;
    }
    /**
     * Protobuf JSON representation for SyncLocalGroupRes
     */
    interface AsProtobufJSON {
        synced?: boolean;
    }
...
/**
 * Message implementation for proto.pub.v1.group.AddMembersToLocalMucReq
 */
export declare class AddMembersToLocalMucReq implements GrpcMessage {
    static id: string;
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
    static deserializeBinary(bytes: ByteSource): AddMembersToLocalMucReq;
    /**
     * Check all the properties and set default protobuf values if necessary
     * @param _instance message instance
     */
    static refineValues(_instance: AddMembersToLocalMucReq): void;
    /**
     * Deserializes / reads binary message into message instance using provided binary reader
     * @param _instance message instance
     * @param _reader binary reader instance
     */
    static deserializeBinaryFromReader(_instance: AddMembersToLocalMucReq, _reader: BinaryReader): void;
    /**
     * Serializes a message to binary format using provided binary reader
     * @param _instance message instance
     * @param _writer binary writer instance
     */
    static serializeBinaryToWriter(_instance: AddMembersToLocalMucReq, _writer: BinaryWriter): void;
    private _group?;
    private _members?;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
     * @param _value initial values object or instance of AddMembersToLocalMucReq to deeply clone from
     */
    constructor(_value?: RecursivePartial<AddMembersToLocalMucReq.AsObject>);
    get group(): protoPubV1Models001.Uid | undefined;
    set group(value: protoPubV1Models001.Uid | undefined);
    get members(): protoPubV1Models002.Member[] | undefined;
    set members(value: protoPubV1Models002.Member[] | undefined);
     ...
     * Cast message to standard JavaScript object (all non-primitive values are deeply cloned)
     */
    toObject(): AddMembersToLocalMucReq.AsObject;
    /**
     * Convenience method to support JSON.stringify(message), replicates the structure of toObject()
     */
    toJSON(): AddMembersToLocalMucReq.AsObject;
    /**
     * Cast message to JSON using protobuf JSON notation: https://developers.google.com/protocol-buffers/docs/proto3#json
     * Attention: output differs from toObject() e.g. enums are represented as names and not as numbers, Timestamp is an ISO Date string format etc.
     * If the message itself or some of descendant messages is google.protobuf.Any, you MUST provide a message pool as options. If not, the messagePool is not required
     */
    toProtobufJSON(options?: ToProtobufJSONOptions): AddMembersToLocalMucReq.AsProtobufJSON;
}
export declare module AddMembersToLocalMucReq {
    /**
     * Standard JavaScript object representation for AddMembersToLocalMucReq
     */
    interface AsObject {
        group?: protoPubV1Models001.Uid.AsObject;
        members?: protoPubV1Models002.Member.AsObject[];
    ...
    /**
     * Protobuf JSON representation for AddMembersToLocalMucReq
     */
    interface AsProtobufJSON {
        group?: protoPubV1Models001.Uid.AsProtobufJSON | null;
        members?: protoPubV1Models002.Member.AsProtobufJSON[] | null;
...
/**
 * Message implementation for proto.pub.v1.group.AddMembersToLocalMucRes
 */
export declare class AddMembersToLocalMucRes implements GrpcMessage {
    static id: string;
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
    static deserializeBinary(bytes: ByteSource): AddMembersToLocalMucRes;
    /**
     * Check all the properties and set default protobuf values if necessary
     * @param _instance message instance
     */
    static refineValues(_instance: AddMembersToLocalMucRes): void;
    /**
     * Deserializes / reads binary message into message instance using provided binary reader
     * @param _instance message instance
     * @param _reader binary reader instance
     */
    static deserializeBinaryFromReader(_instance: AddMembersToLocalMucRes, _reader: BinaryReader): void;
    /**
     * Serializes a message to binary format using provided binary reader
     * @param _instance message instance
     * @param _writer binary writer instance
     */
    static serializeBinaryToWriter(_instance: AddMembersToLocalMucRes, _writer: BinaryWriter): void;
    /**
     * Message constructor. Initializes the properties and applies default Protobuf values if necessary
     * @param _value initial values object or instance of AddMembersToLocalMucRes to deeply clone from
     */
    constructor(_value?: RecursivePartial<AddMembersToLocalMucRes.AsObject>);
    /**
     * Serialize message to binary data
     * @param instance message instance
     */
     ...
     * Cast message to standard JavaScript object (all non-primitive values are deeply cloned)
     */
    toObject(): AddMembersToLocalMucRes.AsObject;
    /**
     * Convenience method to support JSON.stringify(message), replicates the structure of toObject()
     */
    toJSON(): AddMembersToLocalMucRes.AsObject;
    /**
     * Cast message to JSON using protobuf JSON notation: https://developers.google.com/protocol-buffers/docs/proto3#json
     * Attention: output differs from toObject() e.g. enums are represented as names and not as numbers, Timestamp is an ISO Date string format etc.
     * If the message itself or some of descendant messages is google.protobuf.Any, you MUST provide a message pool as options. If not, the messagePool is not required
     */
    toProtobufJSON(options?: ToProtobufJSONOptions): AddMembersToLocalMucRes.AsProtobufJSON;
}
export declare module AddMembersToLocalMucRes {
    /**
     * Standard JavaScript object representation for AddMembersToLocalMucRes
     */
    interface AsObject {
    }
    /**
     * Protobuf JSON representation for AddMembersToLocalMucRes
     */
    interface AsProtobufJSON {
    }
}
