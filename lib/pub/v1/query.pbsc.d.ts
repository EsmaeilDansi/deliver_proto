...
export declare class QueryServiceClient {
    ...
    $raw: {
         ...
         */
        getShowcases: (requestData: thisProto.GetShowcasesReq, requestMetadata?: GrpcMetadata) => Observable<GrpcEvent<thisProto.GetShowcasesRes>>;
        /**
         ...
         */
        getAnnouncement: (requestData: thisProto.GetAnnouncementReq, requestMetadata?: GrpcMetadata) => Observable<GrpcEvent<thisProto.GetAnnouncementRes>>;
    };
     ...
     */
    getShowcases(requestData: thisProto.GetShowcasesReq, requestMetadata?: GrpcMetadata): Observable<thisProto.GetShowcasesRes>;
    /**
     * Unary call @/proto.pub.v1.query.QueryService/GetAnnouncement
     *
     * @param requestMessage Request message
     ...
     */
    getAnnouncement(requestData: thisProto.GetAnnouncementReq, requestMetadata?: GrpcMetadata): Observable<thisProto.GetAnnouncementRes>;
